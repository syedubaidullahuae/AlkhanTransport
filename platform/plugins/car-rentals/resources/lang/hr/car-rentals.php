...
return [
    ...
    'pricing_calendar' => [
        'name' => 'Cjenik kalendar',
        'set_pricing' => 'Postavi cijenu',
        'is_active' => 'Omogući prilagođenu cijenu za ovaj datum',
        'value' => 'Vrijednost cijene',
        'value_type' => 'Vrsta cijene',
        'value_types' => [
            'fixed' => 'Fiksna cijena',
            'amount_adjust' => 'Prilagodba iznosa',
            'percentage_adjust' => 'Postotna prilagodba',
        ],
        'base_price' => 'Osnovna cijena',
        'inactive' => 'Neaktivno',
        'percentage_info' => 'Unesite postotnu vrijednost. Koristite pozitivnu za povećanje (npr: 10 za +10%) ili negativnu za popust (npr: -10 za -10%).',
        'amount_info' => 'Unesite iznos za dodavanje ili oduzimanje od osnovne cijene. Koristite pozitivne vrijednosti za povećanje ili negativne za popust.',
    ],
];
