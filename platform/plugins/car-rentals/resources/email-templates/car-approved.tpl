    ...
    <table class="bb-box" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="bb-content bb-pb-0" align="center">
                ...
                <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/car-rentals::car-rentals.email_templates.car_approved_title' | trans }}</h1>
            </td>
        </tr>
        <tr>
            <td class="bb-content">
                <p>{{ 'plugins/car-rentals::car-rentals.email_templates.hello' | trans }} <strong>{{ author_name }}</strong>,</p>
                <p>{{ 'plugins/car-rentals::car-rentals.email_templates.car_approved_message' | trans({'car_name': car_name, 'site_title': site_title}) }}</p>
            </td>
        </tr>
        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="bb-bb-col">
                                ...
                                <div>{{ 'plugins/car-rentals::car-rentals.email_templates.field_status' | trans }} <strong>{{ 'plugins/car-rentals::car-rentals.email_templates.approved' | trans }}</strong></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
