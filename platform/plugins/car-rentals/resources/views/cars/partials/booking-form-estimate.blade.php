<div class="pricing-summary mb-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-6 text-end"><strong>{{ format_price($tax ?? 0, $currencyId ?? null) }}</strong></div>
    </div>
    <div class="row">
        <div class="col-lg-8 col-6">{{ __('Sale discount') }}</div>
        <div class="col-lg-4 col-6 text-end"><strong>{{ format_price($discount ?? 0, $currencyId ?? null) }}</strong></div>
    </div>
    <div class="row total">
