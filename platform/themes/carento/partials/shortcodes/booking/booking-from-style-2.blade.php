        ...
        <div class="content-booking-form" style="padding-top: 0px;">
            <form action="{{ route('public.checkout.post') }}" method="POST" data-estimate-url="{{ route('public.ajax.booking.estimate') }}" class="booking-form-advance">
                ...
                <div class="item-line-booking border-bottom-0 pb-0">
                    <strong class="text-md-bold neutral-1000">Start Date</strong>
                    <div class="input-calendar">
                        <input class="form-control calendar-date is-valid" type="text" name="rental_start_date" value="{{ $startDate }}" aria-invalid="false">
                ...
                <div class="item-line-booking border-bottom-0 pb-0">
                    <strong class="text-md-bold neutral-1000">Start Date</strong>
                    <div class="input-calendar">
                        <input class="form-control calendar-date is-valid" type="text" name="rental_end_date"  value="{{ $endDate }}" aria-invalid="false">
                        <svg class="icon icon-xs svg-icon-ti-ti-calendar" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12"></path>
                            <path d="M16 3v4"></path>
                            <path d="M8 3v4"></path>
                ...
                <div class="mb-3 position-relative">
                    ...
                    <label class="form-label form-label required" for="customer_name">Full Name </label>
                    <input type="text" name="customer_name" class="booking-input" >
                </div>

                <div class="mb-3 position-relative">

                    <label class="form-label form-label required" for="customer_email">Email </label>
                    <input type="email" name="customer_email" class="booking-input" >
                </div>

                <div class="mb-3 position-relative">

                    <label class="form-label form-label required" for="customer_email">Phone </label>
                    {!! $phoneInput !!}
                </div>
