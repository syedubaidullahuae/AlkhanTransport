<div {!! $shortcode->htmlAttributes() !!} class="shortcode-brands brand-style-1 background-100 pb-70 pt-1">
    <div class="container">
                ...
                @foreach($makes as $make)
                    <div class="brand-logo">
                        <a href="{{ $make->url }}" class="item-brand">
                            ...
                            {{ RvMedia::image($make->getMetaData('logo_dark', true) ?: $make->logo, $make->name, attributes: ['class' => 'dark-mode']) }}
                        </a>
                    </div>
                @endforeach
            </div>
