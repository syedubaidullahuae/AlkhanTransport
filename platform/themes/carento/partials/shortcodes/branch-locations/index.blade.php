<section {!! $shortcode->htmlAttributes() !!} class="shortcode-branch-locations box-section background-body pt-110">
    <div class="container">
                            ...
                            <div class="card-method-contact">
                                ...
                                @if($email = Arr::get($item, 'email'))
                                    <div class="d-flex align-items-center">
                                        ...
                                        {!! Html::mailto($email, attributes: ['class' => 'email text-md-medium ms-2']) !!}
                                    </div>
                                @endif
                            </div>
                        </div>
