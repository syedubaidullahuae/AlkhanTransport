        ...
        <div class="row align-items-center">
            <div class="col-xl-4 col-md-4 mb-10 text-start">
                <div class="box-view-type">
                    @if($enableFilter === 'yes')
                        <a type="button" class="d-lg-none me-3 d-inline-block btn-mobile-filter" data-bs-toggle="offcanvas" data-bs-target="#mobileFiltersOffcanvas" aria-controls="mobileFiltersOffcanvas">
                    ...
                    <span class="text-sm-bold neutral-500 number-found">{{ __(':total items found', ['total' => $cars->total()]) }}</span>
                </div>
            </div>
            <div class="col-xl-8 col-md-8 mb-10 text-lg-end text-start">
                <div class="box-item-sort">
                    ...
                    <div class="item-sort border-1">
                        <span class="text-xs-medium neutral-500 mr-5">{{ __('Show') }}</span>
